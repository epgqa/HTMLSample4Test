...
(function(){
    ...
    this.Tree = new Class({
        ...
        updateElement: function(el){
             ...
             */
            if (this.isCollapsed(ul)) 
                icon.src = "css/tree/Expand.png";
            else 
                icon.src = "css/tree/Collapse.png";
...
.bind(this));
        ...
        expand: function(li){
            ...
            li.getElement(this.options.selector).src = "css/tree/Collapse.png";
        ...
        collapse: function(li){
            ...
            li.getElement(this.options.selector).src = "css/tree/Expand.png";
            li.getElement('span').setProperties({
                'aria-expanded': 'false'
            });

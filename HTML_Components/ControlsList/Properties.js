    ...
    function Element_disabled(value, isSet)
    {
      ...
      if (isSet == 1) {
          $("#" + IDControl)[0].disabled = (value == "true");
      }
    ...
    function Element_innerText(value, isSet) {
        
        if (isSet == 1) {
            document.getElementById(IDControl).innerText = value;
        }
        return document.getElementById(IDControl).innerText;
        //return "";
    }
    ...
    function udpDefaultProperties() {
	    ...
	    for (i = 0; i < PropertyData.length; i++) {
	        ...
	        if (oAttributes.name == "id")
	            ...
	            val = Element_title("", 0)
	        else if (oAttributes.name == "innerText") 
	            val = Element_innerText("", 0)
